...
plot_tile <- function(country_name_idx, country_names_list, y_lim_ranks=NA) {
  ...
  baseplot_ranks <- ggplot(
    ...
    theme(
      ...
      legend.direction = "horizontal",
      legend.margin = margin(110, 0, 0, 15, "pt")
    ) +
    labs(
      x = x_title_ranks,
      y = y_title_ranks,
...
```{r plot-top-countries, echo=FALSE, fig.height=12, fig.width=9, fig.showtext=TRUE}
...
```{r plot-rest-countries, echo=FALSE, fig.height=36, fig.width=9, fig.showtext=TRUE}
